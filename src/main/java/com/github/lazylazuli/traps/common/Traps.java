...
@Mod(modid = Traps.MODID, version = Traps.VERSION + "-" + Traps.BUILD, acceptedMinecraftVersions = Traps.MCVERSION,
		dependencies = "required-after:lazylazulilib@[2.0.0]", updateJSON = Traps.UPDATE)
public class Traps extends LazyLazuliMod
{
	...
	@SidedProxy(clientSide = "com.github.lazylazuli.traps.client.ClientProxy", serverSide = "com.github.lazylazuli" +
			".traps.common.CommonProxy")
